...
<section
  id="contact"
  ref={ref}
  className="relative bg-green-700 py-28 bg-gradient-to-b from-background to-muted overflow-hidden"
>
  <div className="container mx-auto px-4 max-w-7xl relative z-10">
    ...
    <div className="grid lg:grid-cols-[1.4fr_1fr] gap-12">
      ...
      <motion.div
        ...
        className="relative bg-muted border-2 border-border rounded-xl shadow-xl"
      >
        {/* Terminal Header */}
      ...
      >
        ...
        <div className="game-card p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="font-pixel text-sm">Aditya Shrivastava</p>
        ...
        {/* STATS */}
        <div className="game-card p-6">
          <p className="hud-element text-accent mb-4">PLAYER STATS</p>

          <div className="space-y-3">
            <div>
              <p className="font-mono text-xs mb-1">XP</p>
            ...
            <div>
              <p className="font-mono text-xs mb-1">ENERGY</p>
              <div className="h-3 bg-muted rounded overflow-hidden">
